namespace GRC.DataAccess.Configuration
{
    ...
    internal class ControlMechanismConfiguration : IEntityTypeConfiguration<ControlMechanism>
    {
        public void Configure(EntityTypeBuilder<ControlMechanism> builder)
        {
            builder.ToTable("ControlMechanism", "mfk");
            ...
            builder.HasOne(d => d.Origin)
                ...
                .HasConstraintName("FK_ControlMechanism_Origin")
                .IsRequired();
        }
    }
}
